...
public class FireBallAuto implements Drawable,ICoreBase
{
	...
	// private parent
	private TourelleAuto parent;
	
	
	
	public FireBallAuto(TourelleAuto parent,Sprite spriteBall,Vec2 pos,Vec2 velocity) {
		super();
